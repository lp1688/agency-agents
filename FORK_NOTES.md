...
| 檔案 | 說明 |
|------|------|
| `agents-catalog.html` | 全部 279 個 agent 的英文目錄（依 18 個 division 分類，含搜尋與導覽） |
...
| `i18n_chunks/chunk0..5.json` | 由 agent frontmatter 抽出的原文資料（6 份，供翻譯用） |
| `i18n_chunks/chunk0..5.zh-TW.json` | 對應的繁體中文譯文（翻譯記憶，新增 agent 時可增量補譯） |
